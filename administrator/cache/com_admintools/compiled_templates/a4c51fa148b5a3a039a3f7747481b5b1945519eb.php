<?php /* /home/tekweb/public_html/administrator/components/com_admintools/tmpl/AutoBannedAddresses/default.blade.php */ ?>
<?php
/**
 * @package   admintools
...
<?php $this->startSection('browse-table-body-withrecords'); ?>
	...
	<?php foreach($this->items as $row): ?>
		<tr>
			...
			<td>
				<?php echo \Joomla\CMS\Language\Text::_('COM_ADMINTOOLS_LBL_SECURITYEXCEPTION_REASON_' . strtoupper($row->reason)); ?>
			</td>
			<td>
