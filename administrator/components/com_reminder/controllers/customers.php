...
/**
* Reminder Customers Controller
*
* @package	Reminder
* @subpackage	Customers
*/
class ReminderControllerCustomers extends ReminderClassControllerList
{
	/**
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			case 'default.publish':
				$this->applyRedirection($result, array(
					'stay',
					'com_reminder.customers.default'
				), array(
					'cid[]' => null
				));
				break;
