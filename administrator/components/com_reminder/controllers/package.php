...
/**
* Reminder Package Controller
*
* @package	Reminder
* @subpackage	Package
*/
class ReminderControllerPackage extends ReminderClassControllerItem
{
	/**
	...
	*/
	protected function getLayout($default = null)
	{
		...
		return $jinput->get('layout', 'package', 'CMD');
	}
