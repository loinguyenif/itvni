...
/**
* Script file of Reminder component
*
* @package	Reminder
* @subpackage	Installer
*/
class com_reminderInstallerScript
{
	/**
	...
	*/
	...
	{
		$adapter->getParent()->setRedirectURL('index.php?option=com_reminder');
	...
	*/
	public function postflight($type, JAdapterInstance $adapter)
	{
		...
		$txtComponent = JText::_('COM_REMINDER');
