...
<fieldset class="fieldsform form-horizontal">
	...
	<?php
	// Templete
	$field = $fieldSet['jform_templete_id'];
	$field->jdomOptions = array(
		'list' => $this->lists['fk']['templete_id']
			);
	?>
	...
	<?php
	// Package
	$field = $fieldSet['jform_package_id'];
	$field->jdomOptions = array(
		'list' => $this->lists['fk']['package_id']
			);
	?>
	<div class="control-group <?php echo 'field-' . $field->id . $field->responsive; ?>">
		<div class="control-label">
	...
	<?php
	// Company name
	$field = $fieldSet['jform_company_name'];
	?>
	<div class="control-group <?php echo 'field-' . $field->id . $field->responsive; ?>">
		<div class="control-label">
			<?php echo $field->label; ?>
