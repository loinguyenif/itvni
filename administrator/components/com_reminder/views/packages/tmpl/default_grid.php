...
<div class="">
	<table class='table' id='grid-packages'>
		<thead>
			<tr>
				...
				<?php if ($model->canEditState()): ?>
				<th style="text-align:center">
					<?php echo JHTML::_('grid.sort',  "REMINDER_HEADING_ORDERING", 'a.ordering', $listDirn, $listOrder ); ?>
				</th>
				<?php endif; ?>

				<th style="text-align:center">
					<?php echo JHTML::_('grid.sort',  "REMINDER_FIELD_NAME", 'a.name', $listDirn, $listOrder ); ?>
				</th>
				...
				<th style="text-align:center">
					<?php echo JText::_("REMINDER_FIELD_DISK"); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("REMINDER_FIELD_CREATION_DATE"); ?>
				</th>
