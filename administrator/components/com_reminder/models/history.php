...
* @subpackage	Classes
*/
class ReminderModelHistory extends ReminderClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'history', 'STRING');
	}
	...
	*/
	public function getTable($type = 'history', $prefix = 'ReminderTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_reminder.edit.history.data', array());
	...
	* @param	integer	$pk	The primary id key of the history
	*
	* @return	void
	*/
	...
	{
		//FROM : Main table
		$query->from('#__reminder_histories AS a');
