...
class JFormFieldModel extends JFormFieldGroupedList
{
	...
	*/
	protected function getGroups()
	{
		...
		$listGroups = ReminderHelperForm::getElementGroups($this->element);
		...
		$items = ReminderHelperForm::getItems($this);
		...
		foreach($items as $item)
		{
			...
			{
				$val = ReminderHelper::parseValue($item, $labelKey);
				if ($val !== null)
	...
	*/
	protected function getOptions()
	{
		...
		if (!empty($items))
		foreach ($items as $item)
			$options[$item->$listKey] = ReminderHelper::parseValue($item, $labelKey);
	...
	*/
	public function prepareModel(&$model)
	{
		...
		$groups = ReminderHelperForm::getElementGroups($this->element);
