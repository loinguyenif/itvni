...
* @subpackage	Classes
*/
class ReminderModelPackage extends ReminderClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'package', 'STRING');
	}
	...
	*/
	public function getTable($type = 'package', $prefix = 'ReminderTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_reminder.edit.package.data', array());
	...
	* @param	integer	$pk	The primary id key of the package
	*
	* @return	void
	*/
	...
	{
		//FROM : Main table
		$query->from('#__reminder_packages AS a');
