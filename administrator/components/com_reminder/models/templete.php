...
* @subpackage	Classes
*/
class ReminderModelTemplete extends ReminderClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'templete', 'STRING');
	}
	...
	*/
	public function getTable($type = 'templete', $prefix = 'ReminderTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_reminder.edit.templete.data', array());
		...
		if (empty($data)) {
			...
			if ($this->getState('templete.id') == 0)
			{
				$jinput = JFactory::getApplication()->input;
	...
	* @param	integer	$pk	The primary id key of the templete
	*
	* @return	void
	*/
	...
	{
		//FROM : Main table
		$query->from('#__reminder_templetes AS a');
