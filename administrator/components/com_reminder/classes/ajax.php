...
/**
* Ajax Class for Reminder.
*
* @package	Reminder
* @subpackage	Class
*/
class ReminderClassAjax extends JObject
{
	/**
	...
	*/
	public static function responseHook($options = array(), $version)
	{
		...
		switch(strtoupper($options['renderExceptions']))
		{
			...
			case 'HTML':
				$return->transaction->htmlExceptions = ReminderClassView::renderMessages('HTML');
				break;

			case 'TEXT':
				$return->transaction->rawExceptions = ReminderClassView::renderMessages('TEXT');
				break;
			...
			default:
				...
				else
				{
					...
					$return->transaction->exceptions = ReminderClassView::renderMessages(null);
