...
class ReminderHelperEnum
{
	...
	*/
	...
	/**
	* Construct the list : packages_type
	*
	* @access	protected
	* @param	array	$options	Optional config array for developer custom.
	*
	* @return	array	Associative array containing the list. Indexes are doubled (array index + value field).
	*/
	protected function ___packages_type($options = array())
	{
		return array(
			'domain' => array(
				'value' => 'domain',
				'text' => 'REMINDER_ENUM_PACKAGES_TYPE_DOMAIN'
			),
			'hosting' => array(
				'value' => 'hosting',
				'text' => 'REMINDER_ENUM_PACKAGES_TYPE_HOSTING'
			)
		);
	}
	...
	* @param	string	$enumName	Name of the enumeration
	*
	* @return	object	Enumeration instance (ReminderHelperEnum)
	*/
	public static function getInstance($enumName)
	{
		...
		$enumeration = new ReminderHelperEnum($enumName);
