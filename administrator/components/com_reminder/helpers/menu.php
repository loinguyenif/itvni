...
defined('REMINDER_CPANEL_MAX_LENGTH') or define("REMINDER_CPANEL_MAX_LENGTH", null);
defined('REMINDER_CPANEL_ICON_SIZE') or define("REMINDER_CPANEL_ICON_SIZE", 48);
defined('REMINDER_CPANEL_BUTTON_WIDTH') or define("REMINDER_CPANEL_BUTTON_WIDTH", 100);
defined('REMINDER_CPANEL_BUTTON_HEIGHT') or define("REMINDER_CPANEL_BUTTON_HEIGHT", 100);
...
class ReminderHelperMenu
{
	...
	*/
	protected static function getXml()
	{
		...
		{
			if ($client == 'admin')
				$xmlFileBase = JPATH_ADMIN_REMINDER;
			else
				$xmlFileBase = JPATH_SITE_REMINDER;
	...
	*/
	...
	{
		$maxLength = REMINDER_CPANEL_MAX_LENGTH;
		$iconSize = REMINDER_CPANEL_ICON_SIZE;
		$buttonWidth = REMINDER_CPANEL_BUTTON_WIDTH;
		$buttonHeight = REMINDER_CPANEL_BUTTON_HEIGHT;
