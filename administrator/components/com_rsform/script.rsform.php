...
.red {
	...
	<div class="rsform-column-10">
		...
		<?php } ?>
		<h2>Changelog v3.0.16</h2>
		<ul class="version-history">
			<li><span class="version-new">New</span> Email Logging in the Configuration area.</li>
			<li><span class="version-upgraded">Upg</span> UIkit 3 updated to 3.11.1</li>
			<li><span class="version-upgraded">Upg</span> Bootstrap 5 updated to 5.1.3</li>
			<li><span class="version-upgraded">Upg</span> No longer generating labels for elements that have no 'Caption' set (and 'Layout Flow' is set to 'Vertical').</li>
			<li><span class="version-upgraded">Upg</span> 'onRsformCreateMailer' event now provides $args['formId'] as well.</li>
			<li><span class="version-upgraded">Upg</span> TCPDF updated to 6.4.4</li>
			<li><span class="version-fixed">Fix</span> RTL emails are now generated correctly when using 'Auto-Generate Email Message'.</li>
			<li><span class="version-fixed">Fix</span> Bootstrap 4 radio and checkbox HTML markup was incorrectly generated.</li>
		</ul>
